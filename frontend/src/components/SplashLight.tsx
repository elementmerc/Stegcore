...
export default function SplashLight({ onComplete }: SplashProps) {
  ...
  return (
    <>
      <style>{`
        .sc-splash-bar-l { opacity: 0; }
        .sc-splash-word-l { opacity: 0; }
        .sc-splash-tagline-l { opacity: 0; }
        .sc-pulse-l { opacity: 0.2; }
      `}</style>
      <div style={{
        position: 'fixed',
        inset: 0,
