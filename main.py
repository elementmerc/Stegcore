...
class StegGUI(customtk.CTk):
    def __init__(self):
        ...
        #The Encoding button
        self.encode_button = customtk.CTkButton(master=frame, command=self.encoding_event,
                                                text='Embed',
                                                font=('Consolas',19))
        self.encode_button.pack(padx=100, pady=30)

        #The decoding button
        self.decode_button = customtk.CTkButton(master=frame, command=self.decoding_event,
                                                text='Extract',
                                                font=('Consolas', 19))
